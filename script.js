    ...
    function winFlash(array) {
        var flashing = setInterval(function(){
            for ( i = 0; i < array.length; i++ ) {
                if ( $( "#" + array[i] )[0].src === "images/default/" + players[array[i]-1] + ".png" ) {
                    console.log(true);
                    $( "#" + array[i] )[0].src = "images/select/" + players[array[i]-1] + ".png";
                } else {
                    console.log(false);
                    $( "#" + array[i] )[0].src = "images/default/" + players[array[i]-1] + ".png";
                }
            }
        }, 200);
        setTimeout((function(){
    ...
    $( ".box").click(function() {
        ...
        if ( deciding == true ){
            ...
            if ( texts[index].innerHTML == "" ) {
                ...
                idName = "#" + this.id
                var flashing = setInterval(function(){
                    if ( $(idName)[0].src === "images/default/" + players[index] + ".png" ) {
                        console.log(true);
                        $(idName)[0].src = "images/select/" + players[index] + ".png";
                    } else {
                        console.log(false);
                        $(idName)[0].src = "images/default/" + players[index] + ".png";
                    }
                }, 300)
                ...
                $("#xButton").click(function() {
                    ...
                    $("#oButton").remove();
                    $("#cancelButton").remove();
                    $(idName)[0].src = "images/confirm/" + players[index] + ".png";
